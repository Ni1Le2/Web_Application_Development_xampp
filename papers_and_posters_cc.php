...
<body>
    ...
    <div id="publ" class="container-fluid">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<li class="list-group-item"> 
                    <a target="_blank" class="text-dark" href=papers/' . $row["filename"] . '>' . $row["title"] . ' - ' . $row["author"] . ' (' . $row["year"] . ') <i class="bi bi-download"></i></a></li>';
        ...
        <ul class="list-group">
            <li class="list-group-item"> <strong>Posters:</strong></li>
            <li class="list-group-item"> <a href="papers/test_paper.pdf" target="_blank" class="text-dark">- name of poster - Sara Aras 2022 <i class="bi bi-download"></i></a></li>
        </ul> <br>
